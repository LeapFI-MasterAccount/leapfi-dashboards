 ...
 *
 * AI GOVERNANCE FLAGSHIP CALLOUT — MOVED (HF1, user ruling 2026-08-21,
 * superseding L10's always-visible interpretation of call-15/D3's
 * placement half): the Home content area below the greeting must contain
 * NOTHING that is not configured by the user via Customize, so the
